...
#ifndef OSGXR_APP_VIEW_GEOM_SHADERS
#define OSGXR_APP_VIEW_GEOM_SHADERS 1
...
/// Represents an app level view in geometry shaders mode
class AppViewGeomShaders : public AppView
{
    public:

        AppViewGeomShaders(XRState *state,
